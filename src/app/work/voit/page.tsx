...
export default function VoitPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#0D0D0D]">
      ...
      {/* Two-column layout */}
      <div className={`flex-1 flex flex-col md:flex-row ${siteX} pt-8 md:pt-16 pb-8 md:pb-16 gap-10 md:gap-8 xl:gap-[276px]`}>
        ...
        <div className="w-full min-w-0 max-w-[848px] flex flex-col">
          ...
          <section id="overview" className="flex flex-col gap-6 pb-12 sm:pb-16 scroll-mt-28 sm:scroll-mt-40">
            ...
            <div className="flex flex-col gap-3">
              <video
                ...
                loop
                playsInline
                className="w-full h-auto block rounded-2xl sm:rounded-3xl outline outline-1 outline-[#F2F2F2] dark:outline-white/[0.08]"
              >
                <source src="https://voit-videos.s3.us-east-1.amazonaws.com/Explaning%20Video.mp4" type="video/mp4" />
              </video>
          ...
          {/* 2. The System */}
          <section id="the-system" className="flex flex-col gap-6 pb-12 sm:pb-16 scroll-mt-28 sm:scroll-mt-40">
            <h2 className="text-[20px] font-semibold leading-[1.3] tracking-[-0.01em] text-[#333333] dark:text-white">
              2. The System
            </h2>
            <p className="text-[14px] leading-[22px] font-medium text-[#888888]">
          ...
          {/* 3. Design Decisions */}
          <section id="design-decisions" className="flex flex-col gap-8 pb-12 sm:pb-16 scroll-mt-28 sm:scroll-mt-40">
            <h2 className="text-[20px] font-semibold leading-[1.3] tracking-[-0.01em] text-[#333333] dark:text-white">
          ...
          {/* 4. What I Built */}
          <section id="what-i-built" className="flex flex-col gap-8 pb-12 sm:pb-16 scroll-mt-28 sm:scroll-mt-40">
            <h2 className="text-[20px] font-semibold leading-[1.3] tracking-[-0.01em] text-[#333333] dark:text-white">
              4. What I Built
            </h2>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="w-full rounded-2xl sm:rounded-3xl bg-[#F5F5F5] dark:bg-white/[0.06] p-2 sm:p-6">
                    <Image
          ...
          {/* 5. Outcomes */}
          <section id="outcome" className="flex flex-col gap-6 pb-12 sm:pb-16 scroll-mt-28 sm:scroll-mt-40">
            <h2 className="text-[20px] font-semibold leading-[1.3] tracking-[-0.01em] text-[#333333] dark:text-white">
              5. Outcomes
            </h2>
            <p className="text-[14px] leading-[22px] font-medium text-[#888888]">
