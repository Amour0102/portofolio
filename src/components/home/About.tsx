    ...
    <section className="mx-auto flex w-full max-w-[576px] flex-col items-start gap-5">
      ...
      <div className="flex w-full flex-col items-start gap-4">
        {aboutParagraphs.map((p, i) => (
          <p key={i} className="w-full text-[14px] font-medium leading-[22px] text-[#333333] dark:text-white/90">
            {p}
          </p>
        ))}
        <p className="w-full text-[14px] font-medium leading-[22px] text-[#333333] dark:text-white/90">
