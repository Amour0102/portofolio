          ...
          >
            ...
            >
              <Image
                ...
                className="transition-transform duration-500 ease-out group-hover:scale-[1.02] will-change-transform"
                priority
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              <h3
                className="text-[22px] font-semibold leading-[30px] tracking-[-0.02em] text-[#333333] dark:text-white transition-opacity duration-300 ease-out group-hover:opacity-60"
              >
                {project.title}
              </h3>
